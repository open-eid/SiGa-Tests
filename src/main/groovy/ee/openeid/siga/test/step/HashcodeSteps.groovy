...
class HashcodeSteps extends RequestSteps {
    ...
    Response tryUploadContainerFromFile(Flow flow, String containerName) {
        return tryUploadContainer(flow, RequestData.uploadHashcodeRequestBodyFromFile(containerName))
    }
